...
draw_sprite_ext(MOD_GLOBAL.spr_yogurtfirebg, 0, - (SW / 2) + ((_cx - _f2x) + _fs) + (xoff * 0.8), _f2y + _fh, 3, 1, 0, c_white, _al);
draw_sprite_ext(MOD_GLOBAL.spr_yogurtfirebg, 1, - (SW / 2) + ((_cx - _f1x) + _fs) + xoff, _f1y + _fh, 3, 1, 0, c_white, _al);
