        ...
        variables: [
            {
                ...
                variable: "escapetheme",
 				options: ["Sugar Rush (Lila Mix)", "Sugar Rush (Exhibition Night)", "Glucose Getaway!", "Glucose Getaway! (Construct)", "Midi Getaway! (Demo 1)", "Midi Getaway! (Construct)", "THE pizzelle's FAVORITE SONG(...)", "Glucose Getaway! (Fanmade Demo 2 ver.)"],
            ...
            },
            {
                ...
                variable: "lap3theme",
                options: ["Harry's Despair-y (Bilk Mix)", "Harry's Despair-y", "Sugarcube Hailstorm", "Blue Licorice", "Gummy Harry's Brain Freezin' (V1)", "Gummy Harry's Brain Freezin' (V2)", "Coneball Lapping Two"],
        ...
        variables: [
	     {
                ...
                options: ["Exhibition Night", "2022 Demo", "Really Fuckin Fast", "Frenzy Worlds (UNFINISHED)"],
