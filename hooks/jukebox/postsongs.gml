...
add_multisong("event:/sugary/music/soundtest/glucose_getaway", "Glucose Getaway - RodMod",
	"event:/sugary/music/soundtest/glucose_getaway_construct", "Glucose Getaway (Construct) - RodMod",
	"event:/sugary/music/soundtest/glucose_getaway_bewitched", "Glucose Getaway (Bewitched! Remix) - dexiedoo_octo",
	"event:/sugary/music/soundtest/glucose_getaway_demo_2", "Glucose Getaway (Fanmade Demo 2 ver.) - Unknown",
...
add_multisong("event:/sugary/music/soundtest/sweet_release", "Sweet Release of Death (Exhibition Night) - RodMod",
	"event:/sugary/music/soundtest/sweet_release_of_death_old", "Sweet Release of Death (Demo 1 ver.) - RodMod",
