...
heatfillR = spr_heatmeter_fill;
	 ...
	 pizzascoresprR = MOD_GLOBAL.cakehud ;
	 pepperspriteR = MOD_GLOBAL.ctop;
	 pepperonispriteR = MOD_GLOBAL.btop;
	 olivespriteR = MOD_GLOBAL.atop;
	 shroomspriteR = MOD_GLOBAL.stop;
